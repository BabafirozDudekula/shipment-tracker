...
const CreateShipment = lazy(() => import("./pages/CreateShipment.tsx"));
const ShipmentList = lazy(() => import("./pages/ShipmentList.tsx"));
const ShipmentDetails = lazy(() => import("./pages/ShipmentDetails.tsx"));
const HandoverHistory = lazy(() => import("./pages/HandoverHistory.tsx"));
const SupplierManagement = lazy(() => import("./pages/SupplierManagement.tsx"));
        ...
        <BrowserRouter>
          ...
          <Suspense fallback={<RouteLoading />}>
            <Routes>
              ...
              />
              <Route
                path="/shipments/:shipmentId/handovers"
                element={
                  <RequireAuth>
                    <HandoverHistory />
                  </RequireAuth>
